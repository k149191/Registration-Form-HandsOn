...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  void _submitForm() {
    ...
    if (provider.isEmailRegistered(_emailController.text)) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          ...
          backgroundColor: Color.fromARGB(255, 255, 162, 96),
        ),
      );
      return;
    }
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        icon: const Icon(Icons.check_circle, color: Color.fromARGB(255, 163, 242, 166), size: 48),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Registrasi Mahasiswa dan Mahasiswi'),
        actions: [
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Field yang bertanda (*) wajib di isi',
